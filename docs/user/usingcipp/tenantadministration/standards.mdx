...
| Enable Self service password reset                             |   Medium    | Enables Self Service password Reset for _all users_. Communication is important as this requires users to register 2 authentication methods if they haven't already.                                                                                                                                                                                                                                            |
