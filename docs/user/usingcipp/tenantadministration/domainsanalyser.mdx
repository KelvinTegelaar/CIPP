...
| SPF MX Recommended        | SPF is present and set as determined from the MX records.  |   10    |
| SPF Correct All           | SPF is present and set correctly.                          |   10    |
| MX Provider Recommended   | MX records are present and set as recommended by provider. |   10    |
| DMARC Present             | DMARC is present.                                          |   10    |
| DMARC Set Quarantine      | DMARC set to quarantine.                                   |   20    |
| DMARC Set Reject          | DMARC set to reject.                                       |   30    |
