...
Many Exchange reports exist in CIPP, see below for further details:
...
Mailboxes using 90% to 100% of their quota show with a red highlight.
...
* Message Trace currently only shows limited data, such as whether the message was successfully delivered or not. You can't currently see the Message Events indicating why this occurred. 
