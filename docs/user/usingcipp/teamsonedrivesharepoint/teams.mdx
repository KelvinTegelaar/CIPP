...
The Business Voice page gives an overview of all the numbers on the selected tenant.
Detailed information includes who they're assigned to, the number itself, activation state, date purchased and, a number of other fields.

### Details {#businessvoice-details}
...
### Known Issues / Limitations {#businessvoice-knownissues}
...
### Known Issues / Limitations {#listteams-knownissues}
...
### Details {#addteam-details}

:::tip Licence
The owner of the team you select must have a valid Teams licence.
:::
...
### Known Issues / Limitations {#teamsactivity-knownissues}
