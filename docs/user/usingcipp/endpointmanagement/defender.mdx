...
* You must be a current Microsoft Lighthouse partner, and your tenants must be on-boarded to Lighthouse before you can use this.
* The UI is somewhat mixed currently, as for example, it reports a "red cross - danger" warning if a Signature Update isn't required. This should arguably be a green tick.
