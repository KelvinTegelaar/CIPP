...
* As with the Microsoft 365 admin center users view, this view doesn't differentiate between a standard user and a shared mailbox user.
* *All Tenants* overview not currently supported.
* For editing and creating users you must set a usage location in your profile. (Avatar Icon -> Profile)
