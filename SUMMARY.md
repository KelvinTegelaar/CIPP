...
* [Tenant Administration](user-documentation/tenant/README.md)
  ...
  * [Standards](user-documentation/tenant/standards/README.md)
    * [Standards Templates](user-documentation/tenant/standards/list-standards/README.md)
    ...
    * [Tenant Alignment](user-documentation/tenant/standards/tenant-alignment.md)
...
* [Email & Exchange](user-documentation/email/README.md)
  ...
  * [Spamfilter](user-documentation/email/spamfilter/README.md)
    ...
    * [Quarantine Policies](user-documentation/email/spamfilter/list-quarantine-policies-1/README.md)
      * [Add Quarantine Policy](user-documentation/email/spamfilter/list-quarantine-policies-1/add-quarantine-policy.md)
