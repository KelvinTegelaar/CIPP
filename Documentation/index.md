...
If you want to self-host, check out the [installation manual](\GettingStarted\Installation.md). You will need some knowledge of Static Web Apps, Azure Functions, and Azure KeyVault
