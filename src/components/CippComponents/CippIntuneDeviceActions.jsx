...
// Link-type actions (View Device / View in Intune / View in Entra) render on the
// list page but are filtered out of the detail page's ActionsMenu (see
// components/actions-menu.js), so a single array is safe to reuse as-is.
// The `category` and `quickAction` fields drive the fork's categorized action
// menu and the table page's quick-action buttons.
