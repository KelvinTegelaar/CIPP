...
const WhatIfDocument = ({ tenant, stageStates, simulatedTemplate }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer} fixed>
          Generated by CIPP Standards V3 - what-if preview, no changes were
          made.
        </Text>
      </Page>
    </Document>
...
export const CippStandardV3WhatIfReport = ({ tenant, stageStates }) => {
...
export default CippStandardV3WhatIfReport
