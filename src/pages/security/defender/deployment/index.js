  ...
  return (
    <>
      <CippFormPage
        ...
        addedButtons={
          <Button variant="outlined" onClick={templateDialog.handleOpen}>
            Save as Template
          </Button>
        }
        ...
        api={{
          ...
          customDataformatter: (row, action, formData) => {
            ...
            const clean = (section) => {
              ...
              const cleaned = removeNulls(section)
        ...
        fields={[
          {
            ...
            placeholder: 'e.g. Default Defender',
            helperText:
              'Each policy is saved as a separate template prefixed with this name (e.g. "Default Defender - AV Policy").',
            validators: { required: 'Template name prefix is required' },
          },
          {
            type: 'textField',
            name: 'package',
