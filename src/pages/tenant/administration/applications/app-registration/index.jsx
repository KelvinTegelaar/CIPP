...
import { Fingerprint, Launch, Security, Group, CheckCircle, Warning, Badge } from "@mui/icons-material";
...
const Page = () => {
  ...
  const subtitle = appRequest.isSuccess && appData
    ? [
        {
          icon: <Badge />,
      ...
      ? [
          {
            ...
            table: {
              ...
              refreshFunction: refreshFunction,
              simpleColumns: ["displayName", "id", "appOwnerOrganizationId", "servicePrincipalType"],
            },
          },
        ]
      ...
      : [
          {
            ...
            subtext: "No service principal exists yet for this application in the current tenant.",
            statusColor: "warning.main",
                    ...
                    value={
                      <Grid container spacing={2}>
                        ...
                        <Grid size={{ xs: 12 }}>
                          ...
                          <Typography variant="inherit">{data?.publisherDomain || "N/A"}</Typography>
                        </Grid>
                        <Grid size={{ xs: 12 }}>
                          <Typography variant="inherit" color="text.primary" gutterBottom>
                        ...
                        <Grid size={{ xs: 12 }}>
                          ...
                          <Typography variant="inherit">
                            {data?.createdDateTime ? new Date(data.createdDateTime).toLocaleString() : "N/A"}
                          </Typography>
                        </Grid>
                        <Grid size={{ xs: 12 }}>
                          <Typography variant="inherit" color="text.primary" gutterBottom>
                          ...
                          <Typography variant="inherit">{data?.web?.redirectUris?.length || 0}</Typography>
                        </Grid>
                      </Grid>
                    }
                  />
