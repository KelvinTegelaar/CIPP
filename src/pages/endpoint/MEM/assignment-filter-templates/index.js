...
const Page = () => {
  ...
  return (
    <CippTablePage
      ...
      cardButton={
        <>
          <Button component={Link} href="assignment-filter-templates/add" startIcon={<AddBox />}>
            Add Assignment Filter Template
          </Button>
          <Button component={Link} href="assignment-filter-templates/deploy" startIcon={<RocketLaunch />}>
