...
const Page = () => {
  ...
  const actions = [
    ...
    },
    {
      ...
      confirmText: 'Do you want to delete the template [templateName]?',
      multiPost: false,
    },
  ]
  ...
  return (
    <CippTablePage
      ...
      simpleColumns={[
        ...
        'roleScope',
        'roleCount',
        'settings.activationMaxDuration',
        'settings.activationRequires',
        'settings.activationRequiresApproval',
        'settings.eligibilityMaxDuration',
        'settings.activeAssignmentMaxDuration',
        'meetsSecureFloor',
        'updatedBy',
        'updatedDate',
      ]}
