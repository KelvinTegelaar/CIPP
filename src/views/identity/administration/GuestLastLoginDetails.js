...
export default function GuestLastLoginDetails({ tenantDomain, userId, className = null }) {
  const {
    data: user = {},
    isFetching,
    error,
  } = useListGuestQuery({ tenantDomain, userId, IncludeLogonDetails: true })
...
GuestLastLoginDetails.propTypes = {
