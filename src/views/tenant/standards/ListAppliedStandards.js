...
const TenantsList = () => {
  ...
  const columns = [
    ...
    {
      name: 'SendFromAlias',
      selector: (row) => row['SendFromAlias'],
      sortable: true,
    ...
    {
      name: 'unmanagedSync',
      selector: (row) => row['unmanagedSync'],
      sortable: true,
    ...
    },
    {
      ...
      selector: (row) => row['DeletedUserRentention'],
      sortable: true,
    ...
    },
    {
      ...
      selector: (row) => row['DisableUserSiteCreate'],
      sortable: true,
    ...
    },
    {
      ...
      selector: (row) => !!row['sharingCapability'],
      sortable: true,
    ...
    {
      name: 'DisableReshare',
      selector: (row) => row['DisableReshare'],
      sortable: true,
    ...
    },
    {
      ...
      selector: (row) => row['PWnumberMatchingRequiredState'],
      sortable: true,
    ...
    {
      name: 'disableMacSync',
      selector: (row) => row['disableMacSync'],
      sortable: true,
