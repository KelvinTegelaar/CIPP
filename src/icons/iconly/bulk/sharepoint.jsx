 ...
 * recolored to CIPP / CyberDrain navy (#003049 and lighter blues).
...
const SharePoint = ({ fontSize = "inherit", sx, width, height, style, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <circle fill="#0A5570" cx="1482.667" cy="1065.667" r="509.667" />
      <circle fill="#1A7A96" cx="1088.833" cy="1552.167" r="393.833" />
      <path
        opacity="0.1"
        fill="#000000"
      ...
      <defs>
        ...
        >
          <stop offset="0" stopColor="#1A7A96" />
          <stop offset="0.5" stopColor="#0A5570" />
          <stop offset="1" stopColor="#003049" />
        </linearGradient>
      </defs>
      <path
        fill={`url(#${gradientId})`}
