...
Click "Add CIPP Default Roles" to automatically add the 15 recommended roles from the [recommended-roles.md](../../../../setup/maintaining-cipp/recommended-roles.md "mention") page.
