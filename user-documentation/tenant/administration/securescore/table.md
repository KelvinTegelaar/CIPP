...
CIPP will additionally add columns called "Action Url" and "Remediation" with additional information on how to take action on the score component. The "Remediation" column will indicate which CIPP Standard will complete the selected action.
