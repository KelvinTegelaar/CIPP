...
A page for super admins to manage the custom roles deployed to their CIPP instance. Please see the User Roles in CIPP page on [#custom-roles](../../../../../setup/self-hosting-guide/roles.md#custom-roles "mention")for instructions and notes/limitations.
