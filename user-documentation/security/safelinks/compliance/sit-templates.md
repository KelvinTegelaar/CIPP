...
This page will allow you to manage your Sensitivity Label templates.
...
<table><thead><tr><th>Action</th><th>Description</th><th data-type="checkbox">Bulk Action Available</th></tr></thead><tbody><tr><td>Save to GitHub</td><td>Saves the selected label(s) to your GitHub repository of choice.</td><td>true</td></tr><tr><td>Delete Label</td><td>Deletes the selected label(s).</td><td>true</td></tr><tr><td>More Info</td><td>Opens the extended info flyout</td><td>false</td></tr></tbody></table>
