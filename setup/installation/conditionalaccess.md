...
3. Create a new policy and include the CIPP user. Enforce Azure Multi-factor Authentication for each logon each logon, do not add any exclusions or trusted locations.
