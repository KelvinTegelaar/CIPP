$(document).ready(function () {
    ...
    $.ajax({
        ...
        'success': function (GUID) {
            ...
            GetAPIData("api/ExecBECCheck", GUID.GUID).then((data) => {
                ...
                //activesync
                if (data.Results) { $("#loader").html('<i class="fas fa-times-circle text-danger fa-2x"></i>Error - could not retrieve information from API. Please run HAWK instead.') }
