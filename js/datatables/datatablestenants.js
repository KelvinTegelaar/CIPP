    ...
    var oTable = $('.datatable-1').dataTable(
        {
            ...
            "columns": [
                ...
                {
                    "data": "customerId",
                    render: function (customerId, type, row) { return '<a target="_blank" href="https://portal.office.com/Partner/BeginClientSession.aspx?CTID=' + customerId + '&CSDEST=o365admincenter"><i class="fas fa-cog fa-fw"></i></a>' }
                },
                {
                    "data": "defaultDomainName",
