    ...
    $('.datatable-1').dataTable(
        {
            ...
            "columns": [
                ...
                {
                    "data": "id",
                    render: function (id, type, row) { return '<a href=index.html?EditApp&TenantFilter=' + TenantID + '&ID=' + id + '><i data-bs-toggle="tooltip" data-bs-placement="top" title="Edit User" class="fas fa-cog fa-fw"></i></a><nothing class="APILink">' + '<a href=api/AssignApp?AssignTo=AllUsers&TenantFilter=' + TenantID + '&ID=' + id + '><i data-bs-toggle="tooltip" data-bs-placement="top" title="Assign to all users" class="fas fa-user-friends fa-fw"></i></a>' + '<a href=api/AssignApp?AssignTo=AllDevices&TenantFilter=' + TenantID + '&ID=' + id + '><i data-bs-toggle="tooltip" data-bs-placement="top" title="Assign to all devices" class="fas fa-laptop fa-fw"></i></a>' + '<a href=api/AssignApp?AssignTo=Both&TenantFilter=' + TenantID + '&ID=' + id + '><i data-bs-toggle="tooltip" data-bs-placement="top" title="Assign globally(All devices, all Users)" class="fas fa-globe fa-fw"></i></i></a>' + '<a href=AppReport.html?TenantFilter=' + TenantID + '&ID=' + id + '><i data-bs-toggle="tooltip" data-bs-placement="top" title="Report on installation status" class="fas fa-table fa-fw"></i></i></a></nothing>'; }
                }
            ],
            "order": [[0, "asc"]],
        });
